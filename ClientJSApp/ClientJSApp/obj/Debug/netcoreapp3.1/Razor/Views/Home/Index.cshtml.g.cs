#pragma checksum "C:\Development\ClientJSApp\ClientJSApp\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "239cc9daf36fd10fbe0220ab4cc30b8fe1cab20e"
// <auto-generated/>
...
#nullable restore
#line 1 "C:\Development\ClientJSApp\ClientJSApp\Views\_ViewImports.cshtml"
using ClientJSApp;
...
#nullable disable
#nullable restore
#line 2 "C:\Development\ClientJSApp\ClientJSApp\Views\_ViewImports.cshtml"
using ClientJSApp.Models;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"239cc9daf36fd10fbe0220ab4cc30b8fe1cab20e", @"/Views/Home/Index.cshtml")]
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"236775782e57023939e31c84f7017f1153411357", @"/Views/_ViewImports.cshtml")]
    #nullable restore
    ...
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Development\ClientJSApp\ClientJSApp\Views\Home\Index.cshtml"
...
<br />
<div class=""info"">Java:</div><div id=""java"" class=""fp""");
            WriteLiteral(@"></div>
<br />
...
<script>
    function fingerprint_flash() {
        ...
        try {
            ...
            strVersion = objPlayerVersion.major + ");
            WriteLiteral(@"""."" + objPlayerVersion.minor + ""."" + objPlayerVersion.release;
            if (strVersion === ""0.0.0"") {
                strVersion = ""N/A"";
            }
            strOut = strVersion;
    ...
    function fingerprint_browser() {
        ...
        try {
            ...
            WriteLiteral(@"ersion;
                ...
                numVersion = Num");
            WriteLiteral(@"ber(RegExp.$1); // capture x.x portion and store as a number
                strBrowser = ""Mozilla "" + numVersion;
            ...
            } else if (/libwww-perl[\/\s]");
            WriteLiteral(@"(\d+\.\d+)/.test(strUserAgent)) { //test for libwww-perl/x.x or libwww-perl x.x (ignoring remaining digits);
                numVersion = Number(RegExp.$1); // capture x.x portion and store as a number
       ...
       ");
            WriteLiteral(@"         numVersion = Number(RegExp.$1); // capture x.x portion and store as a number
                ...
                numVersion = Number(RegExp.$1); // capture x.x portion and store as a number
                strBrowser = ");
            WriteLiteral(@"""Library (Python URLlib) "" + numVersion;
   ...
   ");
    ...
    function fingerprint_fontsmoothing() {
        ...
        if (typeof (screen.fontSmoothingEnabled) !== ""undefined"") {
            ...
            try {
                fontsmoothing = ""false"";
      ");
            WriteLiteral(@"          canvasNode = document.createElement('canvas');
                canvasNode.width = ""35"";
    ...
    function fingerprint_fonts() {
        ...
        try {
            ...
            fonts = [""Abadi MT Condensed Light"", ""Adobe Fangsong Std"", ""Adobe Hebrew"", ""Adobe Ming Std"", ""Agency FB"", ""Aharoni"", ""Andalus"", ""Angsana New"", ""AngsanaUPC"", ""Aparajita"", ""Arab"", ""Arabic Transparent"", ""Arabic Typesetting"", ""Arial Baltic"", ""Arial Black"", ""Arial CE"", ""Arial CYR"", ""Arial Greek"", ""Arial TUR"", ""Arial"", ""Batang"", ""BatangChe"", ""Bauhaus 93"", ""Bell M");
            WriteLiteral(@"T"", ""Bitstream Vera Serif"", ""Bodoni MT"", ""Bookman Old Style"", ""Braggadocio"", ""Broadway"", ""Browallia New"", ""BrowalliaUPC"", ""Calibri Light"", ""Calibri"", ""Californian FB"", ""Cambria Math"", ""Cambria"", ""Candara"", ""Castellar"", ""Casual"", ""Centaur"", ""Century Gothic"", ""Chalkduster"", ""Colonna MT"", ""Comic Sans MS"", ""Consolas"", ""Constantia"", ""Copperplate Gothic Light"", ""Corbel"", ""Cordia New"", ""CordiaUPC"", ""Courier New Baltic"", ""Courier New CE"", ""Courier New CYR"", ""Courier New Greek"", ""Courier New TUR"", ""Courier New"", ""DFKai-SB"", ""DaunPenh"", ""David"", ""DejaVu LGC Sans Mono"", ""Desdemona"", ""DilleniaUPC"", ""DokChampa"", ""Dotum"", ""DotumChe"", ""Ebrima"", ""Engravers MT"", ""Eras Bold ITC"", ""Estrangelo Edessa"", ""EucrosiaUPC"", ""Euphemia"", ""Eurostile"", ""FangSong"", ""Forte"", ""FrankRuehl"", ""Franklin Gothic Heavy"", ""Franklin Gothic Medium"", ""FreesiaUPC"", ""French Script MT"", ""Gabriola"", ""Gautami"", ""Georgia"", ""Gigi"", ""Gisha"", ""Goudy Old Style"", ""Gulim"", ""GulimChe"", ""GungSeo"", ""Gungsuh"", ""GungsuhChe"", ""Haettenschweiler"", ""Harrington"", ""Hei S"", ""H");
            WriteLiteral(@"eiT"", ""Heisei Kaku Gothic"", ""Hiragino Sans GB"", ""Impact"", ""Informal Roman"", ""IrisUPC"", ""Iskoola Pota"", ""JasmineUPC"", ""KacstOne"", ""KaiTi"", ""Kalinga"", ""Kartika"", ""Khmer UI"", ""Kino MT"", ""KodchiangUPC"", ""Kokila"", ""Kozuka Gothic Pr6N"", ""Lao UI"", ""Latha"", ""Leelawadee"", ""Levenim MT"", ""LilyUPC"", ""Lohit Gujarati"", ""Loma"", ""Lucida Bright"", ""Lucida Console"", ""Lucida Fax"", ""Lucida Sans Unicode"", ""MS Gothic"", ""MS Mincho"", ""MS PGothic"", ""MS PMincho"", ""MS Reference Sans Serif"", ""MS UI Gothic"", ""MV Boli"", ""Magneto"", ""Malgun Gothic"", ""Mangal"", ""Marlett"", ""Matura MT Script Capitals"", ""Meiryo UI"", ""Meiryo"", ""Menlo"", ""Microsoft Himalaya"", ""Microsoft JhengHei"", ""Microsoft New Tai Lue"", ""Microsoft PhagsPa"", ""Microsoft Sans Serif"", ""Microsoft Tai Le"", ""Microsoft Uighur"", ""Microsoft YaHei"", ""Microsoft Yi Baiti"", ""MingLiU"", ""MingLiU-ExtB"", ""MingLiU_HKSCS"", ""MingLiU_HKSCS-ExtB"", ""Miriam Fixed"", ""Miriam"", ""Mongolian Baiti"", ""MoolBoran"", ""NSimSun"", ""Narkisim"", ""News Gothic MT"", ""Niagara Solid"", ""Nyala"", ""PMingLiU"", ""PMingLiU-ExtB"", ""Pal");
            WriteLiteral(@"ace Script MT"", ""Palatino Linotype"", ""Papyrus"", ""Perpetua"", ""Plantagenet Cherokee"", ""Playbill"", ""Prelude Bold"", ""Prelude Condensed Bold"", ""Prelude Condensed Medium"", ""Prelude Medium"", ""PreludeCompressedWGL Black"", ""PreludeCompressedWGL Bold"", ""PreludeCompressedWGL Light"", ""PreludeCompressedWGL Medium"", ""PreludeCondensedWGL Black"", ""PreludeCondensedWGL Bold"", ""PreludeCondensedWGL Light"", ""PreludeCondensedWGL Medium"", ""PreludeWGL Black"", ""PreludeWGL Bold"", ""PreludeWGL Light"", ""PreludeWGL Medium"", ""Raavi"", ""Rachana"", ""Rockwell"", ""Rod"", ""Sakkal Majalla"", ""Sawasdee"", ""Script MT Bold"", ""Segoe Print"", ""Segoe Script"", ""Segoe UI Light"", ""Segoe UI Semibold"", ""Segoe UI Symbol"", ""Segoe UI"", ""Shonar Bangla"", ""Showcard Gothic"", ""Shruti"", ""SimHei"", ""SimSun"", ""SimSun-ExtB"", ""Simplified Arabic Fixed"", ""Simplified Arabic"", ""Snap ITC"", ""Sylfaen"", ""Symbol"", ""Tahoma"", ""Times New Roman Baltic"", ""Times New Roman CE"", ""Times New Roman CYR"", ""Times New Roman Greek"", ""Times New Roman TUR"", ""Times New Roman"", ""TlwgMono"", ""Traditional A");
            WriteLiteral(@"rabic"", ""Trebuchet MS"", ""Tunga"", ""Tw Cen MT Condensed Extra Bold"", ""Ubuntu"", ""Umpush"", ""Univers"", ""Utopia"", ""Utsaah"", ""Vani"", ""Verdana"", ""Vijaya"", ""Vladimir Script"", ""Vrinda"", ""Webdings"", ""Wide Latin"", ""Wingdings""];
            count = fonts.length;
            ...
            body = document.body;
     ");
            WriteLiteral(@"       body.insertBefore(fragment, body.firstChild);
            result = [];
            for (i = 0; i < count; i = i + 1) {
  ...
  ");
            WriteLiteral(@"          if (strTypeLng !== ""undefined"") {
    ...
    function fingerprint_silverlight() {
        ""use strict"";
        var strOnError, objContr");
            WriteLiteral(@"ol, objPlugin, strSilverlightVersion, strOut;
    ...
    function fingerprint_os() {
        ...
        try {
            ...
            strUserAgent = navigator.userAgent.toLower");
            WriteLiteral(@"Case();
            ...
            WriteLiteral(@"nt.indexOf(""windows xp"") !== -1) {
                strOS = ""Windows XP"";
                ...
                strOS = ""Windows ME"";
            } else if (strUserAgent.indexOf(""windows 98"") !==");
            WriteLiteral(@" -1) {
                strOS = ""Windows 98"";
           ...
           ");
            WriteLiteral(@" } else if (strUserAgent.indexOf(""openbsd"") !== -1) {
                strOS = ""Open BSD"";
            ...
            WriteLiteral(@"
                ...
                strOS = ""Mac OS Classic (68000)"";
            } else if (strUserAgent.indexOf(""m");
            WriteLiteral(@"ac_powerpc"") !== -1) {
            ...
            } else if (strUserAgent.index");
            WriteLiteral(@"Of(""blackberry97"") !== -1) {
                ...
                strOS = ""WebOS"";
            } else if (strUserAgent.indexOf(""hpwo");
            WriteLiteral(@"s"") !== -1) {
                strOS = ""WebOS (HP)"";
...
");
            ...
            if (strPlatform.indexOf(""x64"") !== -1) {
                ...
                strOSBits = ""64 bits"";
    ");
            WriteLiteral(@"        } else if (strPlatform.indexOf(""68k"") !== -1) {
                strOSBits = ""64 bits"";
    ...
    function fingerprint_useragent() {
     ...
     ");
            WriteLiteral(@"   /* navigator.cpuClass only supported in IE */
   ...
   ");
    ...
    function fingerprint_truebrowser() {
        ...
        if (document.all && document.getElementById && navigator.savePreferences && (strUserAgent.indexOf(""Netfront"") < 0) && navigator.appName !== ""Blazer"") {
            ...
            WriteLiteral(@" if (navigator.vendor === ""KDE"") {
            ...
            WriteLiteral(@"& !navigator.mimeTypes[""*""]) {
            strBrowser = ""Escape 4"";
        } else if (document.layers) {
 ...
 ");
            WriteLiteral(@"           strBrowser = ""Clue browser"";
            ...
            WriteLiteral(@" (document.all && navigator.appName !== ""Microsoft Pocket Internet Explorer"") {
...
");
            WriteLiteral(@"                } else if (strOriginal.charAt(iCounter) === '\n') {
                    strOut = strOut + ""n"";
                }
            }
            return strOut;
    ...
    /* Detect Plugins */
  ");
            WriteLiteral(@"  function fingerprint_plugins() {
        ""use strict"";
        ...
        try {
            ...
            htIEComponents.pu");
            WriteLiteral(@"t('283807B5-2C60-11D0-A31D-00AA00B92C03', 'DirectAnim'); // DirectAnimation
            ...
            htIEComponen");
            WriteLiteral(@"ts.put('DE5AED00-A4BF-11D1-9948-00C04F98BBC9', 'IEHelpEng'); // Internet Explorer Help Engine
            ...
            htIEComponents.put('44BBA842-CC51-11CF-AAFA-00AA00B6015B', 'NetMeetingNT'); // NetMeeting N");
            WriteLiteral(@"T
            ...
            htIEComponents.put('CC2A9BA0-3BDD-11D0-821E-444553540000', 'TaskScheduler'); // Task ");
            ...
            htIEComponents.put('9030D464-4C02-4ABF-8ECC-5164760863C6', 'WinLive'); // Windows Live I");
            WriteLiteral(@"D Sign-in Helper
                ...
                for (iCount = 0; iCount < htIEComponents.size(); iCount = iCount + 1) {
                    ...
                    if (strVersion) {
                        if (bolFirst === true) {
                            ...
                            ");
            WriteLiteral(@"strTemp += glbSep + strName + glbPair + strVersion;
                        }
                    }
                }
    ...
    document.getElementById('cookie').innerH");
            WriteLiteral(@"TML = fingerprint_cookie();
